...
const Athletes = () => {
  const athletes = [
    ...
    { image: "/images/athletes/guilherme-borges-basso.jpeg",     name: "Guilherme Borges Basso",          achievement: "Vice-campeão Catarinense Sub-Júnior 2025 (-74kg)",                                                quote: "O time é extremamente único e unido. Todos em SC se ajudam de uma maneira surpreendente." },
    ...
    { image: "/images/athletes/leo-namegas.jpeg", name: "Leo Namegas",          achievement: "Melhor Atleta Jr Paulista 2023, Recordista Estadual Agachamento/Terra/Total",                   quote: "A união da equipe é incrível, todos se ajudam e se gostam muito." },
